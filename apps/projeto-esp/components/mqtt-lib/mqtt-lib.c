...
// Handler com toda a logica do MQTT
...
{
    ESP_LOGI(TAG, "[MQTT-LIB] Startup..");
    ESP_LOGI(TAG, "[MQTT-LIB] Free memory: %d bytes", esp_get_free_heap_size());
    ESP_LOGI(TAG, "[MQTT-LIB] IDF version: %s", esp_get_idf_version());
...
void mqtt_subscribe(char* topic) {
    ...
    ESP_LOGI(TAG, "Subscrição feita com sucesso, ID=%d", msg_id);
